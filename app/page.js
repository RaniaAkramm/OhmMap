 ...
 * للخروج من مجلد app والذهاب لمجلد lib نحتاج لـ ../
 */
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans p-4 md:p-8">
      ...
      <nav className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
        ...
        <div className="flex bg-zinc-900 border border-zinc-800 rounded-2xl px-4 py-2.5 items-center w-full md:w-96 shadow-xl">
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          >
            ...
            <div className="absolute top-8 left-8 flex gap-4 z-10">
              <div className="bg-black/80 backdrop-blur-xl p-5 rounded-3xl border border-white/10 shadow-xl">
                <p className="text-[10px] text-zinc-500 uppercase font-black mb-1.5 tracking-widest text-blue-400">Grid Status</p>
                <div className="flex items-center text-green-400 font-mono text-xl font-bold uppercase">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h4 className="text-sm font-black text-zinc-300 uppercase tracking-[0.2em]">Global Load Analytics (24h)</h4>
            </div>
            
            <div className="w-full h-40">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={energyHistory}>
                  <XAxis dataKey="time" stroke="#3f3f46" fontSize={11} tickLine={false} axisLine={false} />
                  <Tooltip 
        ...
        <div className="col-span-12 lg:col-span-4 space-y-6">
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            className="p-8 bg-gradient-to-br from-blue-600 to-indigo-900 rounded-[2.5rem] shadow-2xl shadow-blue-500/20"
          >
            ...
            <p className="text-5xl font-black text-white tracking-tight mb-8 font-mono">DUBAI: 15.4 GW</p>
          </motion.div>
      ...
      <footer className="mt-16 text-center border-t border-zinc-900 pt-10 pb-6 font-black uppercase text-[10px] tracking-[0.4em] text-zinc-600 opacity-50">
          OhmMap.com Assets • Powered by Advanced Energy Grid Technology
      </footer>
    </div>
  );
}
