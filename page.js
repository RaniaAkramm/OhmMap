    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans p-4 md:p-8">
      ...
      <nav className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
        ...
        <div className="flex bg-zinc-900 border border-zinc-800 rounded-full px-4 py-2 items-center w-full md:w-96">
          ...
          <input placeholder="Search global energy nodes..." className="bg-transparent outline-none text-sm w-full" />
        </div>
      </nav>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          {/* New: Energy Chart Section */}
          <div className="bg-zinc-900/50 p-6 rounded-[2.5rem] border border-zinc-800 h-64">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={energyHistory}>
                ...
                <Line type="monotone" dataKey="load" stroke="#3b82f6" strokeWidth={4} dot={{ r: 4, fill: '#3b82f6' }} activeDot={{ r: 8 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-4 space-y-6">
          <motion.div 
            ...
            className="p-8 bg-gradient-to-br from-blue-600 to-blue-700 rounded-[2.5rem] shadow-xl shadow-blue-500/10"
          >
          ...
          <div className="p-8 bg-zinc-900 rounded-[2.5rem] border border-zinc-800">
              ...
              {[1, 2].map((i) => (
                <div key={i} className={cn("p-5 rounded-2xl border bg-zinc-950 border-zinc-800 hover:border-zinc-700 transition-all cursor-pointer group")}>
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="font-bold text-sm group-hover:text-blue-400 transition-colors">Ohm-Charge Node {i}</p>
                      <p className="text-[10px] text-zinc-500 mt-1">Status: High Voltage • Type 4</p>
                    </div>
            ...
            <button className="w-full mt-6 py-4 bg-zinc-800 hover:bg-zinc-700 rounded-2xl text-xs font-bold transition-all uppercase tracking-widest">
              View All Locations
            </button>
          </div>
        </div>
